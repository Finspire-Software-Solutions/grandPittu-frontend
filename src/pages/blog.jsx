          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-8">
              <div className="kf-archive-items">
                ...
                >
                  <div className="image kf-image-hover">
                    <Link to="/blog-single">
                      <img src="images/latest_blog1.jpg" alt="image" loading="lazy" />
                    </Link>
                  </div>
                  <div className="desc">
                    ...
                    <div className="readmore">
                      <Link to="/blog-single" className="kf-btn-link">
                        <span>read more</span>
                ...
                >
                  <div className="image kf-image-hover">
                    <Link to="/blog-single">
                      <img src="images/latest_blog2.jpg" alt="image" loading="lazy" />
                    </Link>
                  </div>
                  <div className="desc">
                    <div className="kf-date">
                ...
                >
                  <div className="image kf-image-hover">
                    <Link to="/blog-single">
                      <img src="images/latest_blog3.jpg" alt="image" loading="lazy" />
                    </Link>
                  </div>
                  <div className="desc">
                    <div className="kf-date">
              ...
              <div
                ...
                data-animate="active"
              >
                <Link className="page-numbers prev" to="/blog">
                ...
                <Link className="page-numbers next" to="/blog">
                  <i className="fas fa-chevron-right" />
                </Link>
              </div>
            </div>
        ...
        <div className="container">
          <div className="kf-brands-items row">
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand1.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand2.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand3.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand4.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand5.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-2">
              ...
              >
                <div className="image">
                  <img src="images/brand6.png" alt="image" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
